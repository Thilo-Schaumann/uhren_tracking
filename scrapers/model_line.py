...
MODEL_LINES = {
    ...
    "cartier": ["Tank", "Santos", "Ballon Bleu", "Pasha", "Clé"],
    ...
    "heuer": ["Montreal", "Carrera", "Monaco", "Autavia", "Camaro"],
    "glashütte original": ["Senator Karrée", "Senator Excellence", "Senator", "PanoMatic", "PanoReserve", "Pano"],
